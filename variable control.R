...
=======
                     "Fac_model","Fac_modeling","Fac_new_age","Fac_no","Fac_safe","Fac_sun","Fac_toko","Fac_trophy","Fac_vacant","Fac_voucher","Fac_webshop","Fac_yes")
>>>>>>> d247c84662d69c9215a2b58094e4d2567871a537
...
reshaped_poi_locations$Fac_fuel<-reshaped_poi_locations$Fac_fuel+reshaped_poi_locations$Fac_gas;reshaped_poi_locations$Fac_gas<-NULL
...
reshaped_poi_locations$Fac_garden_furniture<-reshaped_poi_locations$Fac_garden_furniture+reshaped_poi_locations$Fac_garden_furniture_interior_decoration;reshaped_poi_locations$Fac_garden_furniture_interior_decoration<-NULL
...
<<<<<<< HEAD
                               "Fac_scout_camp","Fac_scout_hall","Fac_scout_hut","Fac_shelter","Fac_toys","Fac_toys_gift_watches","Fac_obstetrician_var","Fac_veterinary")
# 2: gym
...
FAC_sporting <- c("Fac_sports","Fac_club","Fac_clubhouse","Fac_dance","Fac_dancing_school","Fac_dojo","Fac_hockey","Fac_sport","Fac_tennis","Fac_training","Fac_trampoline_park","Fac_water_sports","Fac_yoga","Fac_yoga_studio","Fac_airsoft","Fac_dive_centre")
# 4: hospitality
...
FAC_operations <- c("Fac_copyshop","Fac_delivery","Fac_printshop","Fac_housing","Fac_ink","Fac_loading_dock","Fac_locksmith","Fac_machinery_rental","Fac_machines","Fac_mail","Fac_meeting_centre","Fac_meeting_room","Fac_meetinglocation","Fac_music_studio","Fac_office","Fac_office_supplies","Fac_printer","Fac_printer_ink","Fac_printing","Fac_prison","Fac_rehearsal_studio","Fac_rental","Fac_repair","Fac_restaurant_supplies","Fac_shop_supplies","Fac_solar_panel",
